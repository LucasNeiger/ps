export default {
  ...
  "navbar.avatar.admin": "Panel Admin",
  "navbar.avatar.signout": "Se déconnecter",
  // END navbar
  // /
  "home.title": "Partagez vos fichiers en <h>toute simplicité</h>.",
  "home.description": "Partager des fichiers n'a jamais été aussi simple !",
  "home.bullet.a.name": "Personnalisation",
  "home.bullet.a.description": "Choisissez vous même la durée, l'URL, le mot de passe, et bien plus !",
  ...
  "home.bullet.c.name": "Contrôle",
  "home.bullet.c.description": "Créez un compte pour gérer tous vos partages : modifiez / annulez les à votre guise.",
  "home.button.start": "Connexion",
  "home.button.source": "Créer un compte",
  // END /
  // /auth/signin
  "signin.title": "Content de vous revoir",
  "signin.description": "Vous n'avez pas encore de compte ?",
  "signin.button.signup": "Créer un compte",
  "signin.input.email-or-username": "E-mail ou nom d'utilisateur",
  "signin.input.email-or-username.placeholder": "Email / Nom d'utilisateur",
  "signin.input.password": "Mot de passe",
  "signin.input.password.placeholder": "Mot de passe",
  ...
  "signup.input.email.placeholder": "Votre email",
  "signup.button.submit": "C'est parti !",
  // END /auth/signup
  // /auth/totp
  ...
  "resetPassword.notify.success": "Un message avec un lien pour réinitialiser votre mot de passe a été envoyé si l'email fourni existe.",
  ...
  "account.card.language.description": "Seul le français est actuellement supporté en tant que langue.",
  "account.card.color.title": "Apparence",
  // ThemeSwitcher.tsx
  ...
  "account.shares.button.create": "Créer un partage",
  ...
  "account.reverseShares.description": "Un partage inversé vous permet de générer une URL unique via laquelle des utilisateurs pourront partager des fichiers auquels vous aurez accès.",
  ...
  "account.reverseShares.modal.send-email": "Envoyer des notifications par email",
  "account.reverseShares.modal.send-email.description": "Vous envoi une notification par email lorsqu'un partage est créé avec ce lien de partage inversé (Pas encore disponible).",
  ...
  // Dropzone.tsx
  "upload.dropzone.title": "Uploader des fichiers",
  ...
  "upload.modal.title": "Nouveau Partage",
  ...
  "upload.modal.accordion.email.title": "Adresse email des destinataires",
  ...
  "admin.config.general.app-name": "Nom de du site",
  "admin.config.general.app-name.description": "Le nom du site",
  "admin.config.general.app-url": "URL du site",
  "admin.config.general.app-url.description": "Depuis quel URL le site est disponible",
  ...
  "admin.config.email.enable-share-email-recipients": "Activer le partage par email",
  "admin.config.email.enable-share-email-recipients.description": "Autoriser ou non le partage d'email avec les destinataires. N'activer cette option que si SMTP est activé.",
  "admin.config.email.share-recipients-subject": "Sujet d’un partage",
  "admin.config.email.share-recipients-subject.description": "Intitulé de l'email envoyé aux destinataires d’un partage.",
  "admin.config.email.share-recipients-message": "Message d’un partage",
  "admin.config.email.share-recipients-message.description": "Contenu de l'email qui est envoyé aux destinataires du partage. Variables possibles :\n {creator} - Le nom d'utilisateur du créateur du partage\n {creatorEmail} - L'adresse mail du créateur du partage\n {shareUrl} - L'URL du partage\n {desc} - La description du partage\n {expires} - La date d'expiration du partage.\n Ces variables seront remplacées par leur valeur effective.",
  "admin.config.email.reverse-share-subject": "Sujet d’un partage inversé",
  "admin.config.email.reverse-share-subject.description": "Intitulé de l'email envoyé lorsque quelqu’un a partagé des fichiers depuis votre partage inversé.",
  "admin.config.email.reverse-share-message": "Message d’un partage inversé",
  "admin.config.email.reverse-share-message.description": "Contenu de l'email envoyé lorsque quelqu’un partage des fichiers depuis votre partage inversé. {shareUrl} sera remplacé par le nom du créateur et l’URL de partage.",
  "admin.config.email.reset-password-subject": "Sujet d’une réinitialisation du mot de passe",
  "admin.config.email.reset-password-subject.description": "Intitulé de l'email envoyé lorsqu’un utilisateur demande une réinitialisation de son mot de passe.",
  "admin.config.email.reset-password-message": "Message de réinitialisation du mot de passe",
  "admin.config.email.reset-password-message.description": "Contenu de l'email envoyé lorsqu’un utilisateur demande à réinitialiser son mot de passe. {url} sera remplacé par l’URL de réinitialisation du mot de passe.",
  "admin.config.email.invite-subject": "Sujet d’une invitation",
  "admin.config.email.invite-subject.description": "Intitulé de l'email envoyé lorsqu’un administrateur invite un utilisateur.",
  ...
  "error.msg.no_email": "Impossible d’obtenir l'email du compte {0}.",
